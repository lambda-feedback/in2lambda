...
Imported questions arrive published, with the final answer, worked solution, structured tutorial and chatbot shown to students. The Python API can set each of these per question.
