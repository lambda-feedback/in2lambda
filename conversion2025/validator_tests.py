...
class TestMathDelimiterChecker(unittest.TestCase):
    ...
    def test_valid_single_dollar_with_period(self):
        ...
        self.assertEqual(math_delimiter_checker(content), Passed)
    ...
    def test_no_closing_single_dollar(self):
        content = "This is an inline math expression: $x = y."
        self.assertEqual(math_delimiter_checker(content), MissingClosingSingleDollar)
    ...
    def test_invalid_newline_in_inline_middle(self):
        ...
        self.assertEqual(math_delimiter_checker(content), InvalidNewlineInsideInlineMathExpression)
    ...
    def test_invalid_incorrect_closing_single_dollar_delimiter(self):
        ...
        self.assertEqual(math_delimiter_checker(content), DoubleDollarInsteadOfClosingSingleDollar)
    ...
    def test_invalid_triple_dollar(self):
        content = "Expression $$$x = y$$$."
        self.assertEqual(math_delimiter_checker(content), MissingNewLineBeforeOpeningDisplayMathDelimiter)
    ...
    def test_no_closing_double_dollar(self):
        content = "This is a display math expression:\n$$\nx = y\n"
        self.assertEqual(math_delimiter_checker(content), MissingClosingDoubleDollar)

    def test_no_opening_double_dollar(self):
        content = "This is a display math expression:\nx = y\n$$"
        self.assertEqual(math_delimiter_checker(content), MissingNewLineAfterOpeningDisplayMathDelimiter)
    ...
    def test_valid_no_newline_after_double_dollar(self):
        content = "This is a display math expression:\n$$\nx = y\n$$."
        self.assertEqual(math_delimiter_checker(content), MissingNewLineAfterClosingDisplayMathDelimiter)
    ...
    def test_invalid_text_before_closing_double_dollar(self):
        content = "Expression:\n$$\nx = y\ntext$$"
        self.assertEqual(math_delimiter_checker(content), MissingNewLineBeforeClosingDisplayMathDelimiter)
