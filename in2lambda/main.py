...
def compare(built_zip: str, export_dir: str, known_path: Optional[str]) -> None:
    ...
    compared as a straight quote, the notation inside maths is dropped, an image is
    compared by the file's name, and a lone empty part is dropped. in2lambda.compare says
    which notation and why. --known names a file of the differences the two sets are known
    to have, one per line as this command prints it, with a ticket written after "  # ".
