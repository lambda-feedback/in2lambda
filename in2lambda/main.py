...
def compare(built_zip: str, export_dir: str, known_path: Optional[str]) -> None:
    ...
    which notation and why. --known names a file of the differences the two sets are
    known to have, one per line as this command prints it, with a ticket written after
    "  # ". in2lambda compare
